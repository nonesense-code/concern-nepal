  ...
  const data = [
    {
        ...
        property : "h-[240px] text-center m-2 rounded-2xl w-[293px] bg-[#01389263] flex flex-col justify-center items-center"

    },
    {
      number :"",
      des:'' ,
      property : "h-[240px] text-center m-2 rounded-2xl w-[293px] bg-white flex flex-col justify-center items-center"
  ...
  return (
    ...
    <div className="h-[90vh]   p-6">
      ...
      <div className="text-center mb-12">
          ...
          <p className="text-lg mt-2">Why do you need concern Nepal 
         <span className="text-[#D90E31] font-semibold"> your research</span>
         </p>
         </div>
         ...
         <div className="flex flex-wrap w-[50%] "  >
              {data.map((item,index)=>(
                <div key={index} className={item.property}>
                  <h1 className="text-white font-bold text-[48px]">{item.number}</h1>
